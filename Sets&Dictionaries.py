...
{x: x**3 for x in (1, 2, 3, 4, 5)}
 ...
 for x, y in knights.items():     # x = key, y = value
 	print(x, y)


for x, y in emumerate(['tic', 'tac', 'toe']):
	print(x, y)
...
for q, a in zip (questions, answers):
	print('What is your {0}? It is {1}. It is {2}'.format(q, a))

#Sum

questions = ['name', 'quest', 'favorite colot']
answers = ['lancelot', 'the holy grail', 'blue']
result = ['1', '2', '3']
